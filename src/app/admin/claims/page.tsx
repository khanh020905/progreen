    ...
    <AdminLayout>
      <div className="space-y-12">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6">
          ...
          <button onClick={exportToCSV} className="px-6 py-3 bg-[#0e2114] text-white rounded-xl text-xs font-black uppercase tracking-widest hover:bg-black transition-all flex items-center gap-2">
          ...
          <div className="p-8 md:p-10 flex flex-col md:flex-row gap-6 border-b border-slate-50">
            <div className="flex-1 relative">
              ...
              <input 
                ...
                className="w-full pl-14 pr-6 py-4 bg-slate-50 rounded-2xl outline-none focus:bg-white focus:ring-1 focus:ring-green-500 transition-all font-bold text-sm"
                value={searchTerm}
                ...
                {loading ? (
                  ...
                  <tr key={claim._id} className="hover:bg-slate-50/30 transition-colors group">
                    <td className="px-10 py-6">
                      <span className="text-[11px] font-black text-green-700 bg-green-50 px-3 py-1.5 rounded-lg border border-green-100">
