...
function SuccessContent() {
  ...
  const reference = searchParams.get('ref') || 'PGL-2026-XXXXXX';
      ...
      >
        <div className="flex justify-center mb-10">
          <motion.div 
            ...
            className="w-24 h-24 bg-green-50 text-green-600 rounded-full flex items-center justify-center"
          >
        ...
        <div className="flex flex-col gap-4">
          <Link href="/" className="w-full py-4 bg-black text-white rounded-xl font-bold hover:bg-slate-800 transition-colors flex items-center justify-center gap-2">
            Quay lại Trang chủ <Home className="w-4 h-4" />
          </Link>
          <div className="flex items-center justify-center gap-2 text-green-600 text-[10px] font-bold uppercase tracking-widest mt-4">
